...
Anleitung zum (fast) automatisierten Erstellen eines Mashup-Videos.
...
ffmpeg installieren:
* _https://www.gyan.dev/ffmpeg/builds/#release-builds_
...
* Exporteinstellungen:
  ...
  * Datei-Typ: WAV
  * Bit-Tiefe: 32
* Exportierte Datei als `wav.wav` in den Ordner `mashupvid` kopieren.

## Standbild erzeugen
* Datei `generate_img.bat` editieren
